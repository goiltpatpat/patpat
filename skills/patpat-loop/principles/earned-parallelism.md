...
Before admitted fan-out, bind the gate evidence to the active program, validated plan, integration owner, and one unique isolation identity per unit. A boolean claim or missing receipt forces serial work. Recompute and rebind when the plan, frontier, integration owner, or isolation identity changes. The execution workflow owns receipt mechanics and team-shape selection; neither grants execution or delivery authority.
