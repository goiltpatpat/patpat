...
Judgment failure classes are instruction-contract checks, not live-agent behavioral proof. Rubric examples: unnecessary questions, unnecessary planning, unnecessary artifacts, unnecessary fan-out, unnecessary abstraction, over-rigor on simple work, under-escalation on risky work, proxy proof, symptom patches, ignored architecture friction, context-window waste, and crossed authority.
