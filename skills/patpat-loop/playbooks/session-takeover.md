...
7. Before pausing again, validate state, write an atomic checkpoint, name the earliest resumable node, record blockers, and leave external delivery authority unchanged.
