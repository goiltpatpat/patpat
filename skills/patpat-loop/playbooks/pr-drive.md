...
5. If the user named commit, push, pull request, or merge, hand that exact action to [authorized delivery](authorized-delivery.md). If they did not name it, stop at the evidence report.
